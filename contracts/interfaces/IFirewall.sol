...
interface IFirewall {
     ...
     * @param policy The address of the policy contract.
     */
    event GlobalDryrunPolicyPreSuccess(
        address indexed consumer,
        address policy
    );
     ...
     * @param policy The address of the policy contract.
     */
    event GlobalDryrunPolicyPostSuccess(
        address indexed consumer,
        address policy
    );
     ...
     * @param error The error message.
     */
    event GlobalDryrunPolicyPreError(
        address indexed consumer,
        address policy,
        bytes error
    );
     ...
     * @param error The error message.
     */
    event GlobalDryrunPolicyPostError(
        address indexed consumer,
        address policy,
        bytes error
    );
